 // Script to determine the positions of objects on in the sky at the given location and time, and add them to a database.
...
var YYYY; //year input
var MM; // month input
var DDdd; // day/hour/minutes converted to fractions of a day
var DD; // day input
var HH; // hour input
var MM; // minute inout
var SS; // second input
...
var starFile = "hyg6+.csv"

// ==========
// DataConstruction Calls
// The functions used to add each type of object to the starmap are called here.
// ==========
...
// ==========
// Data Construction Function Definitions
// The functions used to determine the locations of an object type and add its position and relevant data to the data file are defined here.
// ==========

// Tentative CSV formatting: ObjectType, Label, 

// Stars / Constellations
function buildStars() {

    console.log("Adding stars to the database.")
...
function buildPlanets() {
    ...
    console.log("Adding planets to the database.")

} // UNFINISHED

// Messier deep space objects
function buildMessier() {

    console.log("Adding Messier deep space objects to the database.")

} // UNFINISHED

// ==========
// Arthmetic Function Definitions
// These are used in the formulae for determining positions of objects on the starmap.
// ==========
